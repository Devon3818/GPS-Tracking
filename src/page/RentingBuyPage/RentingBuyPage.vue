...
export default {
    ...
    data(){
        return {
            ...
            simple: [
                {
                    src: "https://img2.mukewang.com/szimg/5b4ff61700010bbe09000300.jpg"
                },
                {
                    src: "https://img2.mukewang.com/szimg/5b4d546c0001d12709000300.jpg"
                }
            ],
            typeList: [
                [],
    ...
    methods: {
        path( id ){
            return { name: 'RBuyShow', params: { id: id }}
        },
        more_conditionInit(){
            this.$request.post('/user_api/house_rent/more_condition',qs.stringify( {"type":1} )).then(rs=>{
                console.log(rs)
        ...
        house_type_listInit(){
            this.$request.post('/user_api/house_rent/house_type_list',qs.stringify( {"type":1} )).then(rs=>{
                console.log(rs)
        ...
        price_conditionInit(){
            this.$request.post('/user_api/house_sale/common/price_condition',qs.stringify( {"type":1} )).then(rs=>{
                console.log(rs)
